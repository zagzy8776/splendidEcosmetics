...
app.use(cors({
  origin: (origin, callback) => {
    // Allow requests with no origin (mobile apps, curl, UptimeRobot, Render health checks)
...
app.use(express.json({ limit: "2mb" })); // Products with Cloudinary URLs can be large
